...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_shapiro = QtWidgets.QCheckBox(parent=self.centralwidget)
        ...
        self.line_legend = QtWidgets.QFrame(parent=self.centralwidget)
        self.line_legend.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        self.line_legend.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_legend.setObjectName("line_legend")
        self.horizontalLayout_7.addWidget(self.line_legend)
        self.pushButton_legend_window = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButton_legend_window.setObjectName("pushButton_legend_window")
        self.horizontalLayout_7.addWidget(self.pushButton_legend_window)
        self.pushButton_save_legend = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButton_save_legend.setObjectName("pushButton_save_legend")
        self.horizontalLayout_7.addWidget(self.pushButton_save_legend)
